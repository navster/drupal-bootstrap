...
function bigdaddy_form_system_theme_settings_alter(&$form, $form_state) {
  ...
  $form['development_tools']['bigdaddy_wireframes'] = array(
    '#type'          => 'checkbox',
  ...
  $form['development_tools']['bigdaddy_css_prototyping'] = array(
    '#type'          => 'checkbox',
  ...
  $form['development_tools']['bigdaddy_grid_system'] = array(
    '#type'          => 'checkbox',
  ...
  $form['development_tools']['bigdaddy_display_viewport'] = array(
    '#type'          => 'checkbox',
  ...
  $form['development_tools']['bigdaddy_html5_placeholder'] = array(
    '#type'          => 'checkbox',
